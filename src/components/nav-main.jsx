...
//       {items.map((item) => (
//         <Collapsible key={item.text} asChild defaultOpen={item.isActive ||  "true"}>
//           <SidebarMenuItem>
...
//             <SidebarMenuButton asChild tooltip={"human"}>
//               <a href={""}>
//                 {/* {React.isValidElement(item.icon) ? (
//                   item.icon // If icon is an inline SVG, render directly
//                 ) : (
//                   <item.icon /> // If icon is a component, render as a component
//                 )} */}
